...
return [
    ...
    */
    ...
    'single_visit' => env('TRAFFIC_SINGLE_VISIT', true),
    ...
    |--------------------------------------------------------------------------
    |
    | Do not record visits for robots, spiders or crawlers.
    |
    */

    'ignore_robots' => env('TRAFFIC_IGNORE_ROBOTS', true),
    ...
    |--------------------------------------------------------------------------
    |
    | Do not record visits for the following IPs.
    |
    */
